  ...
  return (
    ...
    >
          ...
          <div>
            ...
            <div className="h-44 w-full flex items-center justify-center relative">
              ...
              <div className="absolute text-center">
                <span className="text-[10px] font-mono font-bold text-slate-400 block uppercase">TOTAL HOLD</span>
        ...
        <Card className="lg:col-span-2">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-3 mb-4 border-b border-slate-100">
            <div>
              ...
              <p className="text-xs text-slate-900 font-extrabold mt-0.5 font-heading">
          ...
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={MOCK_CHART_DATA}>
                ...
                <YAxis stroke="#64748B" fontSize={10} tickLine={false} tickFormatter={(val) => `${(val / 1000000).toFixed(1)}M`} />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        ...
        <div className="p-5 rounded-2xl bg-[#0F172A] text-white shadow-sm flex flex-col justify-between relative overflow-hidden">
          <div>
        ...
        <div className="p-5 rounded-2xl bg-white border border-slate-200/80 shadow-xs flex flex-col justify-between">
          <div>
            <span className="text-[10px] font-mono font-bold uppercase tracking-widest text-slate-400 block">MTN MOMO RECONCILED</span>
            <h4 className="text-2xl font-extrabold font-mono text-slate-900 mt-2 tracking-tight">{formatXAF(54200000)}</h4>
          </div>
          <div className="mt-5 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500 font-semibold">
            ...
            <span className="text-slate-900 font-bold">62.7% Volume</span>
          </div>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-white border border-slate-200/80 shadow-xs flex flex-col justify-between">
          <div>
            <span className="text-[10px] font-mono font-bold uppercase tracking-widest text-slate-400 block">ORANGE MONEY RECONCILED</span>
            <h4 className="text-2xl font-extrabold font-mono text-slate-900 mt-2 tracking-tight">{formatXAF(32150000)}</h4>
          </div>
          <div className="mt-5 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500 font-semibold">
            <span>USSD #150# Node</span>
            <span className="text-slate-900 font-bold">37.3% Volume</span>
          </div>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-white border border-slate-200/80 shadow-xs flex flex-col justify-between">
          <div>
            <span className="text-[10px] font-mono font-bold uppercase tracking-widest text-slate-400 block">NET REVENUE (3.5% FEE)</span>
            <h4 className="text-2xl font-extrabold font-mono text-slate-900 mt-2 tracking-tight">{formatXAF(4820000)}</h4>
          </div>
          <div className="mt-5 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500 font-semibold">
            <span>Monthly Yield</span>
            <span className="text-emerald-700 font-bold">+14.2% YoY</span>
          </div>
        </div>
      </div>
      ...
      <Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div
            ...
            className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 flex items-start justify-between cursor-pointer hover:border-slate-400 transition-all"
          >
            <div>
              <span className="text-xs font-bold text-slate-900 block font-heading">Douala Tech Hub</span>
          ...
          >
            <div>
              <span className="text-xs font-bold text-slate-900 block font-heading">Dispute #WB-2026-9842</span>
          ...
          >
            <div>
              <span className="text-xs font-bold text-slate-900 block font-heading">Penja Organic Farm</span>
