...
export const SidebarNav: React.FC = () => {
  ...
  return (
    <aside className="w-64 bg-white text-slate-700 flex flex-col border-r border-slate-100 shadow-sm flex-shrink-0 z-20">
      {/* Brand Header */}
      <div className="h-20 px-6 flex items-center space-x-3 border-b border-slate-100/80">
      ...
      {/* Top User Avatar Profile Card (Inspired by Reference Design) */}
      {user && (
