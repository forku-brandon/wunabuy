  ...
  return (
    <ScreenContainer scrollable={false} padded={false}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        {/* Detailed Delivery & Directions Card for Buyer */}
        <Card style={styles.addressDirectionsCard}>
          <View style={styles.sectionHeaderRow}>
            ...
            <Text variant="caption" bold color={theme.textSecondary} style={{ letterSpacing: 0.5 }}>
              DELIVERY ROUTE &amp; DIRECTION DETAILS
            </Text>
          </View>

          {/* Route Timeline Grid */}
          <View style={[styles.routeBox, { backgroundColor: isDark ? colors.neutral[800] : colors.neutral[50], borderColor: theme.border }]}>
            {/* Step 1: Merchant Store Pickup Address */}
            <View style={styles.routeStepRow}>
              ...
              <View style={styles.stepContentCol}>
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                  ...
                  <Badge label="PICKED UP ✓" variant="success" size="small" />
                </View>
                <Text variant="bodyMedium" bold style={{ marginTop: 2 }}>
                  Douala Tech Hub (Akwa)
                </Text>
                <Text variant="caption" color={theme.textSecondary} style={{ marginTop: 1, lineHeight: 18 }}>
                  📍 Rue Joss, Akwa, Douala (Opposite Place du Gouvernement) • 📱 +237 670 123 456
                </Text>
              </View>
            </View>
            ...
            {/* Step 2: Buyer Destination Address & Directions */}
            <View style={styles.routeStepRow}>
              ...
              <View style={styles.stepContentCol}>
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                  ...
                  <Badge label="EN ROUTE 🏍️" variant="primary" size="small" />
                </View>
                <Text variant="bodyMedium" bold style={{ marginTop: 2 }}>
                  Sanusi Olamide (Home Address)
                </Text>
                <Text variant="caption" color={theme.textSecondary} style={{ marginTop: 1, lineHeight: 18 }}>
                  📍 Rue Joss, Akwa, Douala • Near BICEC Bank Main Gate
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={[styles.directionNoteCard, { backgroundColor: isDark ? 'rgba(13,148,136,0.15)' : '#F0FDFA', borderColor: colors.primary[300] }]}>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <Ionicons name="compass" size={16} color={colors.primary[600]} />
              <Text variant="caption" bold color={colors.primary[700]} style={{ marginLeft: 6 }}>
                LIVE DRIVER DIRECTION &amp; STATUS:
              </Text>
            </View>
            <Text variant="caption" color={theme.text} style={{ marginTop: 3, lineHeight: 18 }}>
              Rider <Text bold>Jean-Paul Mbida</Text> is currently 1.8 km away (ETA: ~8 mins). Travelling along Boulevard de la Liberté towards Akwa.
            </Text>

            <TouchableOpacity
              activeOpacity={0.8}
              onPress={handleCallDriver}
              style={[styles.callDriverActionBtn, { backgroundColor: colors.primary[500] }]}
            >
              <Ionicons name="call" size={14} color="#FFFFFF" />
              <Text variant="caption" bold color="#FFFFFF">
                Call Driver Jean-Paul (+237 675 112 233)
              </Text>
            </TouchableOpacity>
          </View>
        </Card>
